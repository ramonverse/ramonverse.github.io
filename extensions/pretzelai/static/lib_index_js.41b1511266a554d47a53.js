    ...
    activate: async (app, palette, notebookTracker, settingRegistry) => {
        ...
        commands.addCommand(command, {
            ...
            execute: () => {
                ...
                const codeMirrorEditor = (_a = activeCell === null || activeCell === void 0 ? void 0 : activeCell.editor) === null || _a === void 0 ? void 0 : _a.getSelection();
                console.log('CodeMirror Editor instance:', codeMirrorEditor);
                console.log('asdfsda');
                console.log('Highlighted code:', activeCell === null || activeCell === void 0 ? void 0 : activeCell.model.sharedModel.source);
...
//# sourceMappingURL=lib_index_js.41b1511266a554d47a53.js.map